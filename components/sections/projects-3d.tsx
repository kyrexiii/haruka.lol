...
export default function Projects3D() {
  ...
  return (
    <section className="w-full py-24 md:py-32 flex flex-col items-center justify-center relative">
      <div className="w-full flex justify-between items-end mb-16 border-b border-white/5 pb-4">
         <div>
            <div className="text-white/30 text-[10px] font-mono tracking-widest uppercase mb-2">
              [ 02_FEATURED_WORKS ]
            </div>
      ...
      <div className="w-full mt-16 md:hidden flex justify-center">
         <Link href="/projects" className="px-6 py-3 border border-white/10 rounded-full text-xs font-mono uppercase tracking-widest text-foreground hover:bg-white/5 transition-colors">
            View All Archive
         </Link>
      </div>
    </section>
